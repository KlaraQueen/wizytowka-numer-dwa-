...
export const Section = styled.section`
  ...
  box-shadow: 0 4px 16px ${({ theme }) => theme.color.shadow}, 0 2px 6px ${({ theme }) => theme.color.shadow}, 0 0 0 1px rgba(30, 58, 95, 0.06);
  position: relative;
  display: flex;
...
export const ImageWrapper = styled.div`
  ...
  overflow: hidden;
  box-shadow: 0 4px 12px ${({ theme }) => theme.color.shadow}, 0 0 0 1px rgba(30, 58, 95, 0.04);
